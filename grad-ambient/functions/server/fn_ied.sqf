...
params ["_markerArray", "_amount", "_canbeshot"];

iedMkr=_markerArray; //List of markers to spawn IEDs in
iedNum=_amount;                               //Number of IEDs per marker, defined in iedMkr  [Default: 5]
iedDmg=_canbeshot;                           //Can the IED be killed with weapons?           [Default: false] TRUE = Yes | FALSE = Can only be disarmed
